...
namespace eval ::optrace {
  variable script "D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.runs/clk_wiz_0_synth_1/clk_wiz_0.tcl"
...
set cacheID [config_ip_cache -export -no_bom  -dir D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.runs/clk_wiz_0_synth_1 -new_name clk_wiz_0 -ip [get_ips clk_wiz_0]]
...
if { [catch {
  file copy -force D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.runs/clk_wiz_0_synth_1/clk_wiz_0.dcp d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.v d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.vhdl d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.v d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.vhdl d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_stub.v D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.ip_user_files/ip/clk_wiz_0
  }
}

if {[file isdir D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force d:/ayxtk/chiplab/IP/xilinx_ip/2023.2/clk_wiz_0_loongson/clk_wiz_0_stub.vhdl D:/ayxtk/chiplab/fpga/loongson/2023.2/system_run.ip_user_files/ip/clk_wiz_0
  }
}
